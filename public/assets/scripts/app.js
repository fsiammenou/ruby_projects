...
jQuery(document).ready(function(){
    $('a.delete').on('click', function(e){
        ...
        setTimeout($('#delete.modal span.data_content').html($(this).attr('data-content')), 1000);
        setTimeout($('#delete.modal button.delete').attr({'data-post': $(this).attr('data-post')}), 1000);
    });

    $('#delete.modal button.delete').on('click', function(){
        var $this = $(this);
